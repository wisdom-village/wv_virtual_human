package com.virtualhuman.voicedictionary.Activity;
...
import com.virtualhuman.voicedictionary.Activity.Fragment.Dictionary;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dictionary) {
            ...
            fragementManager.beginTransaction().replace(R.id.content_main, fragment).commit();
        }
